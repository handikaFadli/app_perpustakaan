...
<body>
    <div id="app">
        ...
        <div class="main-content container-fluid">
            ...
            <h1 class="mb-4">
                <i class="fa-solid fa-fw fa-user-tie"></i> Petugas
            </h1>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $row['role']; ?></td>
                                                <td>
                                                    <a href="<?= "formUbah.php?aksi=petugas&&id=$row[id_petugas]"; ?>" class="badge bg-primary"><i class="fa-solid fa-fw fa-pencil"></i></a>
                                                    <a href="<?= "prosesPetugas.php?&&aksi=delete&&id=$row[id_petugas]"; ?>" class="badge bg-danger" onclick="javascript: return confirm('Apakah anda yakin ingin dihapus?')"><i class="fa-solid fa-fw fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
